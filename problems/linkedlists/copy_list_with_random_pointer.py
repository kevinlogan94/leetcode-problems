...
# parameter - linked_list: ListNode
# return - head_of_new_linked_list: ListNode

# Q - Linked_list be empty? no
# Q - Linked

# double pass
# loop through list and create copies
# loop through list again and set random pointer on copy
